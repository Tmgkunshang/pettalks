...
session_start();
    ...
    <div class="card-account card-container text-center mt-5 mb-5 py-4">
        ...
        <div class="btn">
            ...
            <a href="./index.php" title="Back To Home" class="btn btn-success" style="height:40px; background-color: black; border: 2px solid black;">Continue Shopping</a>
...
<?php
    ...
    ?>
    <div style="height:40px; background-color: black; border: 2px solid black;" class="card-account card-container text-center mt-5 mb-5 py-4">
