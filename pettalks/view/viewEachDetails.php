            ...
            <div class="col">
                ...
                <p class="card-text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="currency" >$ <?= $res['unit_price'] ?></div>
                        ...
                        {
                        ?>
                        <button style="background-color: #ffc226; color: black; border: 2px solid black;" type="submit" class="btn btn-danger mt-1 " name="addToCart" style="height:40px">Add To Cart</button>
                        <?php
                        }else{
                        ?>
                            <!-- Trigger the modal with a button -->
                            <button type="button" class="btn btn-danger mt-1" style="height:40px" data-toggle="modal" data-target="#myModal">
                                Add To Cart
                            </button>
                        <?php
                        }
            ...
            <div class="col py-5">
                ...
                <div>
                    <form action="./controller/addReviewController.php" method="POST">
                        ...
                        <button style="background-color: #ffc226; color: black; border: 2px solid black;" class="btn btn-primary mt-3" type="submit" name="sendReview">Send Review</button>
                    </form>
                </div>
