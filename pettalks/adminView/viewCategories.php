...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      ...
      <td><button style="background-color: #ffc226; color: black; border: 2px solid black;" class="btn btn-danger" onclick="categoryDelete('<?=$row['category_id']?>')">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' action="./controller/addCatController.php" method="POST">
            ...
            <div class="form-group">
              <button type="submit" class="btn" name="upload" style="height:40px; background-color: #ffc226; color: black;">Add Category</button>
            </div>
          </form>

        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" style="height:40px" style="background-color: #ffc226; color: black;">Close</button>
        </div>
      </div>
