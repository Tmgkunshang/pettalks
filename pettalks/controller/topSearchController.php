    ...
    <div class="col-sm-3" >
        <div class="card" style="height:25rem;">
            <div class="box">
                ...
                <div class="middle">
                    <div class="text" style="height:40px; background-color: black; border: 2px solid black;" onclick="eachDetailsForm('<?= $res['product_id']?>');">View Details</div>
                </div>
            </div>
            <div class="card-body">
                ...
                <p class="card-text">
                    <form action="./controller/addToCartController.php" method="POST">
                        ...
                        {
                        ?>
                        <button style="height:40px; background-color: black; border: 2px solid black;" type="submit" class="btn btn-success mt-1 " name="addToCart" style="height:40px">Add To Cart</button>
                        <?php
                        }else{
                        ?>
